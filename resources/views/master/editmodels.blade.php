...
<x-app-layout>
 ...
 <div class="p-4 sm:ml-64">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            <h2 class="text-center text-blue-600 my-5 text-2xl">Edit Models</h2>

   <form method="POST" action="{{ url('update-models/'.$fmodels->id) }}">
    @csrf
    @method('PUT')
